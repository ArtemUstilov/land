            ...
            <section id={'contacts-section1'}>
                ...
                <div className="row icons">
                    <div className="col-md-4 icon-box">
                        ...
                        <p style={{fontSize: "11px"}}>г. Хмельницкий ул. Подольская 10/3</p>
                    </div>
                    <div className="col-md-4 icon-box">
                        <a href="tel:+380971234567"><img src={Tel} alt="" className="icon-c"/></a>
                        <p style={{fontSize: "13px"}}><a href="tel:+380971234567"> +38(097)123-456-7 </ a></p>
                    </div>
                    <div className="col-md-4 icon-box">
                ...
                <p>Симон Болівар — найвідоміший політичний діяч Південної Америки. Його численні пам'ятники, статуї є чи
                    не в кожному місті Венесуели. Його ім'ям називають вулиці, установи тощо.</p>
                <br/>
                <p>Вплив і авторитет Болівара в першій половині XIX століття примусили зважати на його думку мало не
                    півсвіту. Його всерйоз побоювалися створені незадовго до цього Сполучені Штати Північної Америки,
